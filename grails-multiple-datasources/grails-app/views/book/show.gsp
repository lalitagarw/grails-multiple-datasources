	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<g:if test="${bookInstance?.rate}">
				<li class="fieldcontain">
					<span id="rate-label" class="property-label"><g:message code="book.rate.label" default="Rate" /></span>
					
						<span class="property-value" aria-labelledby="rate-label"><g:fieldValue bean="${bookInstance}" field="rate"/></span>
